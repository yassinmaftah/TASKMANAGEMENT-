...
require_once 'app/Entities/Developer.php';
require_once 'app/Entities/Manager.php';
require_once 'app/Entities/FeatureTask.php';
require_once 'app/Entities/BugTask.php';
